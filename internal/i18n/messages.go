...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.product_catalog_review_required":          "供应商目录商品需先在“商品映射”中审核后才能上架",
		...
		"error.reseller_support_telegram_invalid":        "Telegram 链接格式不正确，请使用 https://t.me/ 开头的链接",
		...
		"error.provider_catalog_sync_required":   "FansGurus 和 TGX 商品请通过“站点连接”中的“同步 Provider 目录”更新",
		"error.tgx_inventory_only":               "只有 TGX 商品可以刷新实时库存",
		"error.tgx_inventory_refresh_failed":     "刷新 TGX 实时库存失败",
	...
	LocaleTW: {
		...
		"error.product_catalog_review_required":          "供應商目錄商品需先在「商品映射」中審核後才能上架",
		...
		"error.reseller_support_telegram_invalid":        "Telegram 連結格式不正確，請使用 https://t.me/ 開頭的連結",
		...
		"error.provider_catalog_sync_required":   "FansGurus 與 TGX 商品請透過「站點連接」中的「同步 Provider 目錄」更新",
		"error.tgx_inventory_only":               "只有 TGX 商品可以重新整理即時庫存",
		"error.tgx_inventory_refresh_failed":     "重新整理 TGX 即時庫存失敗",
	...
	LocaleEN: {
		...
		"error.product_catalog_review_required":          "Approve this provider catalog item in Product Mappings before publishing it",
		...
		"error.reseller_support_telegram_invalid":        "Invalid Telegram link; it must start with https://t.me/",
		...
		"error.provider_catalog_sync_required":   "Refresh FansGurus and TGX products through Sync Provider Catalog in Site Connections",
		"error.tgx_inventory_only":               "Only TGX products support real-time inventory refresh",
		"error.tgx_inventory_refresh_failed":     "Failed to refresh TGX real-time inventory",
