	...
	return []RoleSeed{
		...
		},
		{
			...
			Policies: []Policy{
				...
				{Object: "/admin/product-mappings/:id/platform", Action: "PUT"},
				{Object: "/admin/product-mappings/:id/platform", Action: "DELETE"},
				{Object: "/admin/product-mappings/:id/sync", Action: "POST"},
				{Object: "/admin/product-mappings/:id/tgx-inventory", Action: "POST"},
				...
				{Object: "/admin/procurement-orders/:id/resolve-manual-review", Action: "POST"},
				{Object: "/admin/procurement-orders/:id/sync-status", Action: "POST"},
