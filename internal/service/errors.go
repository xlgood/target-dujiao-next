...
var (
	...
	ErrCouponPaymentRoleNotAllowed         = errors.New("coupon payment role not allowed")
	...
	ErrResellerAccountingUnavailable       = errors.New("reseller accounting unavailable")
	ErrResellerLedgerInvalidSnapshot       = errors.New("reseller ledger invalid snapshot")
	ErrResellerDisabled                    = errors.New("reseller disabled")
	ErrResellerApplyDisabled               = errors.New("reseller apply disabled")
	ErrResellerNotOpened                   = errors.New("reseller not opened")
	ErrResellerProfileInactive             = errors.New("reseller profile inactive")
	ErrResellerProfileStatusInvalid        = errors.New("reseller profile status invalid")
	ErrResellerDomainInvalid               = errors.New("reseller domain invalid")
	ErrResellerDomainConflict              = errors.New("reseller domain conflict")
	...
	ErrResellerWithdrawCurrencyUnavailable = errors.New("reseller withdraw currency unavailable")
	ErrResellerWithdrawStatusInvalid       = errors.New("reseller withdraw status invalid")
	ErrResellerBalanceAccountFrozen        = errors.New("reseller balance account frozen")
	...
	ErrResellerPriceBelowBase              = errors.New("reseller price below base")
	ErrResellerMarkupExceeded              = errors.New("reseller markup exceeded")
	ErrResellerCouponNotAllowed            = errors.New("reseller coupon not allowed")
	ErrResellerPricingModeInvalid          = errors.New("reseller pricing mode invalid")
